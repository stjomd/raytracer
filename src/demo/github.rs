...
fn scene() -> Scene {
	...
	let sph = Sphere::new(Point::origin(), 1.0, Material::Dielectric { ridx: 1.5 });

	let sphere_l = Sphere::new(
		Point::new(-1.01, 0.12, -2.3),
		1.0,
		Material::Matte {
			color: Color(0.24, 0.16, 0.37),
		},
	);
